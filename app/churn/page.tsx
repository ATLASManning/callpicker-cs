...
import { REPORTE_S19_SEPTIEMBRE_2026 } from './reporte-actual'
...
/* ═══════════════════════════════════════════════════════════════════════
   ARCHIVADO — el S18 dejó de ser el corte vigente el 9 sep 2026, cuando
   llegó la Semana 19. Se conserva aquí para que siga siendo consultable
   desde el selector de períodos. El vigente vive en reporte-actual.ts.
═══════════════════════════════════════════════════════════════════════ */
/* ═══════════════════════════════════════════════════════════════════════
   REPORTE SEMANAL — SEMANA 18 · CIERRE AGOSTO 2026  (1 sep 2026)
   Primer envío con la nueva cadencia semanal en martes.
═══════════════════════════════════════════════════════════════════════ */
const REPORTE_S18_AGOSTO_2026: ChurnReporte = {
  id:      's18-agosto-2026',
...
export default function ChurnPage() {
  ...
  const allReportes: ChurnReporte[] = [REPORTE_ABRIL_2026, REPORTE_S4_MAYO_2026, REPORTE_S5_MAYO_2026, REPORTE_S1_JUNIO_2026, REPORTE_S2_JUNIO_2026, REPORTE_S3_JUNIO_2026, REPORTE_S4_JUNIO_2026, REPORTE_CIERRE_JUNIO_2026, REPORTE_S1_JULIO_2026, REPORTE_S2_JULIO_2026, REPORTE_S3_JULIO_2026, REPORTE_S4_JULIO_2026, REPORTE_S2_AGOSTO_2026, REPORTE_S3_AGOSTO_2026, REPORTE_S18_AGOSTO_2026, REPORTE_S19_SEPTIEMBRE_2026, ...userReportes]
  const reporte = allReportes.find(r => r.id === selectedId) ?? REPORTE_S19_SEPTIEMBRE_2026
